...
?>
    <tr>
        ...
        <td>
            <div class="btn-group">
                <a class="btn btn-mini" href="<?php echo BASE_URL ?>edit_combo/<?php echo $result->id; ?>"><i class="icon-edit"></i> Edit</a>
...
<a class="btn btn-success" href="<?php echo BASE_URL ?>add_combo/<?php echo $meta['comboid']; ?>"><i class="icon-plus icon-white"></i> Add Price</a>
