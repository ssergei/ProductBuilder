	$(document).ready(function () {
			...
			$('#firstone').change(function () {
				...
				$.ajax({
					type: "POST",
					url: install_path+"/index.php/json/" + $('option:selected', this).val() + "/" + $('option:selected', this).attr('data-level') + "/" + $('option:selected', this).attr('data-order') + "/",
					dataType: 'json',
			...
			$('#dynamicboxes').on("change", "select", function () {
				...
				$.ajax({
					type: "POST",
					url: install_path+"/index.php/json/" + $('#firstone option:selected').val() + "/1/" + $nextStep + "/" + $('option:selected', this).val(),
					dataType: 'json',
				...
				$("#combolink").attr("href", install_path+"/index.php/pricelist/" + $.md5($productID) + "/");
				
				//get the pricelist if there is one for the combo id 
				$.ajax({
					type: "POST",
					url: install_path+"/index.php/jsonPrices/" + $.md5($productID) + "/",
					dataType: 'json',
					success: function (data) {
